  ...
  return (
    <div className="todo-list">
      <div className="left-panel">
        ...
        <p className="todo-message para">{getTodoMessage()}</p> {/* Added "para" class here */}
      ...
      <div className="right-panel">
        ...
        <p className="para">{selectedTodo ? selectedTodo.description : todos.length === 0 ? 'Select a todo' : ''}</p> {/* Updated condition here */}
      </div>
    </div>
  );
};
